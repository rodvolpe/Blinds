...
/**
 * USAGE:
 * 1 - To use this file replace "joost" with the name of
...
// Replace 'joost' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function joost_form_system_theme_settings_alter(&$form, &$form_state)  {
